...
int main()
{
    ...
    feature_computer3u8f::selected_features_type selected_features = {std::make_pair("GaussianSmoothing", 1.0f), std::make_pair("Gaussian Smoothing", 3.5f)};
    ...
    // read raw data and iterate over blocks
